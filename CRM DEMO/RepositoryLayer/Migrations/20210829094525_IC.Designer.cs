...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Models.CourseEnquiry", b =>
                {
                    ...
                    b.Property<string>("enquityStatus")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DomainLayer.Models.Resource", b =>
                {
                    ...
                    b.Property<DateTime>("resRecordDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DomainLayer.Models.ResourceEnquiry", b =>
                {
                    ...
                    b.Property<string>("resEnquiryStatus")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DomainLayer.Models.CourseEnquiry", b =>
                {
                    b.HasOne("DomainLayer.Models.Course", "Courses")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainLayer.Models.ResourceEnquiry", b =>
                {
                    b.HasOne("DomainLayer.Models.Resource", "Resources")
                        .WithMany()
